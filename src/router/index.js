...
export const constantRouterMap = [
...

  {
    ...
    children: [
      ...
      },
      {
        path: 'addHospSet',
        name: '医院设置添加',
        component: () => import('@/views/hospset/addHospSet'),
      ...
      },
      {
        ...
        name: '修改医院设置',
        component: () => import('@/views/hospset/addHospSet'),
        meta: { title: '修改医院设置', noCache: true },
        hidden: true
      },
      {
        path: 'hosp/list',
        ...
        meta: { title: '医院列表', noCache: true, icon: 'tree'},
      },
      {
        ...
        name: '排班',
        component: () => import('@/views/hosp/department'),
...

  {
    ...
    children: [
        ...
        {
          path: 'orderInfo/show/:outTradeNo',
          name: '查看',
