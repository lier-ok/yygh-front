  ...
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="操作" width="100" align="center">
        <template slot-scope="scope">
          <router-link :to="'/order/orderInfo/show/'+scope.row.outTradeNo">
...
export default {
  ...
  methods: {
    ...
    fetchData(page = 1) {
      ...
      // 异步获取远程数据（ajax）
      this.page = page
      orderInfoApi.getOrdersPage(this.page, this.limit, this.searchObj).then(
        response => {
          debugger
    ...
    getStatusList() {
      orderInfoApi.getOrderAllStatus().then(response => {
