<template>
    <div class="header-container">
        ...
        <div class="right-wrapper">
          <div><span class="v-link clickable">帮助中心</span></div>
 ...
 // 微信登录回调处理
  ...
  methods: {
    ...
    login() {
      ...
      if (this.userInfo.code.length != 5) {
    ...
    weixinLogin() {
      ...
      weixinApi.getLoginParams().then(response => {
        var obj = new WxLogin({
        self_redirect:true,
        id: 'weixinLogin', // 需要显示的容器id
        appid: response.data.app_id, // appid
