...
export default {
  ...
  methods: {
    cancelOrder(){
        weixinApi.cancelOrderRefund(this.orderId).then(response => {
    ...
    init() {
      orderInfoApi.getOrderDetail(this.orderId).then(response => {
    ...
    pay() {
      ...
      weixinApi.getPaymentParams(this.orderId).then(response => {
